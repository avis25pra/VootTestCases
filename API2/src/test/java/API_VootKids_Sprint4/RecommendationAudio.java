...
public class RecommendationAudio extends GenericMethod_VK
{
	...
	@Test
	public void recommendationAudio() throws EncryptedDocumentException, InvalidFormatException, IOException 
	{
		...
		Sheet sh=wb.getSheet("RecommendationAudio");
		...
		for(int i=1; i<=rowCount;i++)
		 {
			//getting the values from excel sheet
			 ...
			 {
				 RecommendationAudio.NotPassUseCaseId(i,URL);
				 continue;
			 }
			 ...
			 {
				 RecommendationAudio.NotPassMethod(i,URL);
				 continue;
			 }
			 if(uId.equals("EMPTY"))
			 {
			 ...
			 {
				 RecommendationAudio.NotPassUid(i,URL);
				 continue;
			 }
			 ...
			 {
				 RecommendationAudio.NotPassProfileId(i,URL);
				 continue;
			 }
			 ...
			 {
				 RecommendationAudio.NotPassLimit(i,URL);
				 continue;
			 }
			 ...
			 {
				 RecommendationAudio.NotPassOffset(i,URL);
				 continue;
			 }
			...
			//posting request
			 ...
			 if(TestType.equals("Positive"))
			 {
				...
				//writing back to excel
	             GenericMethod_VK.ExcelWriteBack(path4, "RecommendationAudio", i, 12, resp1, 13, TestType, counter, bool, myValue, Value2test, 14, 15,mynullKeys,myErrorArray );
					
	        }
		 	GenericMethod_VK.write2Master(2, "RecommendationAudio", 13,path4);
