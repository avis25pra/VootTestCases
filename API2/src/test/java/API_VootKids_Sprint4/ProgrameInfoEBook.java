...
public class ProgrameInfoEBook extends GenericMethod_VK
{
	...
	@Test
	public void programInfoEBook() throws EncryptedDocumentException, InvalidFormatException, IOException 
	{
		...
		Sheet sh=wb.getSheet("ProgrammeInfoEBook");
		...
		for(int i=1; i<=rowCount;i++)
		 {
			//getting the values from excel sheet
			 ...
			 {
				 ProgrameInfoEBook.NotPassMediaId(i,URL);
				 continue;
			 }
			 ...
			 {
				 ProgrameInfoEBook.NotPassMediaTypeId(i,URL);
				 continue;
			 }
			 ...
			 {
				 ProgrameInfoEBook.MandatoryParams(i,URL);
				 continue;
			 }
			 if(mediaId.equals("NA") && mediaTypeId.equals("NA"))
			 {
				 ProgrameInfoEBook.NonMandatoryParams(i,URL);
				 continue;
			 }
			//posting request
			 BasicConfigurator.configure();
			 ...
			 {
				 ProgrameInfoEBook.PositiveScenarios(i, resp1);
				 continue;
			 }
			...
			//writing back to excel
             GenericMethod_VK.ExcelWriteBack(path4, "ProgrammeInfoEBook", i, 10, resp1, 11, TestType, counter, bool, myValue, Value2test, 12, 13,mynullKeys,myErrorArray );
					
	        }
		 	GenericMethod_VK.write2Master(3, "ProgrammeInfoEBook", 11,path4);
	...
	//function for pasing mandatory params
