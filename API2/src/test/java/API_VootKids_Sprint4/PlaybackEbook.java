...
public class PlaybackEbook extends GenericMethod_VK
{
	...
	@Test
	public void playbackEbook() throws EncryptedDocumentException, InvalidFormatException, IOException 
	{
		...
		Sheet sh=wb.getSheet("PlaybackEbook");
		...
		for(int i=1; i<=rowCount;i++)
		 {
			//getting the values from excel sheet
			 ...
			 {
				 PlaybackEbook.NotPassMediaId(i,URL);
				 continue;
			 }
			 ...
			 {
				 PlaybackEbook.NotPassMediaTypeId(i,URL);
				 continue;
			 }
			 ...
			 {
				 PlaybackEbook.MandatoryParams(i,URL);
				 continue;
			 }
			 if(mediaId.equals("NA") && mediaTypeId.equals("NA"))
			 {
				 PlaybackEbook.NonMandatoryParams(i,URL);
				 continue;
			 }
			 ...
			 {
				 PlaybackEbook.PositiveScenarios(i, resp1);
				 continue;
			 }
			...
			//writing back to excel
             GenericMethod_VK.ExcelWriteBack(path4, "PlaybackEbook", i, 10, resp1, 11, TestType, counter, bool, myValue, Value2test, 12, 13,mynullKeys,myErrorArray );
					
	        }
		 	GenericMethod_VK.write2Master(5, "PlaybackEbook", 11,path4);
