...
public class ForgotPin extends GenericMethod_VK
{
	static String email;
	static String URL;
	static int counter;
	...
	public void Forgot_Pin() throws EncryptedDocumentException, InvalidFormatException, IOException
	{
	    ...
	    for(int i=1; i<=rowCount;i++)
        {
				...
				GenericMethod_VK.ExcelWriteBack(path1, "ForgotPIN", i, 7, resp1, 8, TestType, counter, bool, myValue, Value2test, 9, 10,mynullKeys,myErrorArray);
        }
	    GenericMethod_VK.write2Master(6,"ForgotPIN",8,path1);
